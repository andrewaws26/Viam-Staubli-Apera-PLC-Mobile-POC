...
const styles = StyleSheet.create({
  ...
  progressText: { color: colors.textSecondary, fontSize: typography.sizes.sm, fontFamily: typography.fonts.heading },
  categoryCard: { marginHorizontal: spacing.lg, marginBottom: spacing.md },
  categoryTitle: { color: colors.text, fontSize: typography.sizes.base, fontFamily: typography.fonts.heading, marginBottom: spacing.md },
  ...
  successTitle: { color: colors.text, fontSize: typography.sizes['2xl'], fontFamily: typography.fonts.heading },
