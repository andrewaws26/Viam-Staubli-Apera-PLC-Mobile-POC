      ...
      {showForm && (
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-5 space-y-4">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button
              onClick={resetForm}
              className="px-4 py-2 text-sm font-semibold rounded-lg bg-gray-800 hover:bg-gray-800/50 text-gray-300 transition-colors"
            >
              Cancel
            </button>
          </div>
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-1">
                        <button
                          ...
                          className="px-2 py-1 text-xs font-semibold rounded bg-gray-800 hover:bg-gray-800/50 text-gray-300 transition-colors"
                        >
                          Edit
                        </button>
                        <button
