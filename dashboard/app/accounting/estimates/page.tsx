...
export default function EstimatesPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      <AppNav pageTitle="Estimates & Quotes" />
      ...
      <main className="px-4 sm:px-6 py-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-[10px] text-gray-600 uppercase tracking-wider mb-1">Total Estimates</div>
            <div className="text-xl font-bold text-gray-100">{totalEstimates}</div>
          </div>
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-[10px] text-gray-600 uppercase tracking-wider mb-1">Open (Draft + Sent)</div>
            <div className="text-xl font-bold text-blue-400">{openCount}</div>
          </div>
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-[10px] text-gray-600 uppercase tracking-wider mb-1">Accepted</div>
            <div className="text-xl font-bold text-emerald-400">{acceptedCount}</div>
          </div>
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-[10px] text-gray-600 uppercase tracking-wider mb-1">Converted to Invoice</div>
        ...
        {showCreate && (
          <div className="mb-6 p-6 rounded-xl bg-gray-900/50 border border-gray-800 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <div>
                <label className="block text-[10px] text-gray-600 uppercase tracking-wider mb-1">Estimate Date</label>
              ...
              <div>
                <label className="block text-[10px] text-gray-600 uppercase tracking-wider mb-1">Expiry Date</label>
