      ...
      <main className="px-4 sm:px-6 py-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Total Invoices</div>
          ...
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Overdue</div>
            <div className="text-xl font-bold text-red-400">{fmtCurrency(totalOverdue)}</div>
          </div>
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Paid (All Time)</div>
        ...
        {showCreate && (
          <div className="mb-6 p-6 rounded-xl bg-gray-900/50 border border-gray-800 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Invoice Date</label>
        ...
        {showPayment && (
          <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-900 rounded-xl border border-gray-700 p-6 w-full max-w-md space-y-4">
              ...
              <div>
                <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Reference / Check #</label>
