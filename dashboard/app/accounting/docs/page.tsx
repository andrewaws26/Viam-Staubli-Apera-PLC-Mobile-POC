...
export default function AccountingDocsPage() {
  return (
    <DocsLayout
      title="IronSight Accounting — User Guide"
      subtitle="Complete documentation for the IronSight Company OS financial system. Covers every module from chart of accounts to payroll tax filing."
      sections={sections}
    >
      {/* ── OVERVIEW ───────────────────────────────────────── */}
      ...
      <DocSection id="getting-started" title="Getting Started">
        ...
        <H3>Navigation</H3>
        <P>
          All accounting pages are in the Finance section of the top navigation. The sidebar
          organizes pages into groups: Sales, Expenses, Banking, Payroll, Taxes, Reports,
          and Accounting.
        </P>
      </DocSection>
