      ...
      <main className="px-4 sm:px-6 py-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Rules</div>
          ...
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Categorized</div>
            <div className="text-xl font-bold text-blue-400">{categorizedCount}</div>
          </div>
          <div className="p-4 rounded-xl bg-gray-900/50 border border-gray-800">
            <div className="text-xs text-gray-500 uppercase tracking-wider mb-1">Total Charges</div>
                ...
                {showCreateRule && (
                  <div className="mb-6 p-6 rounded-xl bg-gray-900/50 border border-gray-800 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Rule Name *</label>
                      ...
                      <div>
                        <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Match Type *</label>
                      ...
                      <div>
                        <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Pattern *</label>
                      ...
                      <div>
                        <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">GL Account</label>
                      ...
                      <div>
                        <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Priority (0-100)</label>
                ...
                <div className="rounded-xl border border-gray-800 bg-gray-900/50 overflow-hidden overflow-x-auto">
                  <table className="w-full text-sm min-w-[900px]">
                    ...
                    <tbody>
                      ...
                      {rules.length === 0 && (
                        <tr><td colSpan={8} className="px-4 py-8 text-center text-gray-500">No rules yet. Create your first rule above.</td></tr>
                      )}
                    </tbody>
                  </table>
                </div>
              ...
              <div>
                ...
                {showCreateCC && (
                  <div className="mb-6 p-6 rounded-xl bg-gray-900/50 border border-gray-800 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                      <div>
                        <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Card Name *</label>
                        <input value={ccName} onChange={(e) => setCcName(e.target.value)} placeholder="e.g., Company Chase Visa"
                          className="w-full px-3 py-2 rounded-lg bg-gray-900 border border-gray-800 text-sm text-white" />
                      </div>
                      <div>
                        <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Last 4 Digits</label>
                      ...
                      <div>
                        <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Liability GL Account</label>
                ...
                <div className="rounded-xl border border-gray-800 bg-gray-900/50 overflow-hidden overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      ...
                      {ccAccounts.length === 0 && (
                        <tr><td colSpan={5} className="px-4 py-8 text-center text-gray-500">No credit card accounts. Create one to start importing transactions.</td></tr>
                      )}
                    </tbody>
                  </table>
                </div>
              ...
              <div className="space-y-6">
                <div className="p-6 rounded-xl bg-gray-900/50 border border-gray-800 space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">Credit Card Account *</label>
                    ...
                    <div>
                      <label className="block text-xs text-gray-500 uppercase tracking-wider mb-1">CSV File *</label>
                        ...
                        <table className="w-full text-sm">
                          ...
                          <tbody>
                            ...
                            {csvPreview.length > 50 && (
                              <tr><td colSpan={3} className="px-4 py-2 text-center text-gray-500 text-xs">...and {csvPreview.length - 50} more rows</td></tr>
                            )}
                          </tbody>
                        </table>
                      </div>
