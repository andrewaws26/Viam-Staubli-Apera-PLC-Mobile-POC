...
export default function PlcDetailPanel({ readings }: Props) {
  ...
  return (
    <div className="space-y-3 sm:space-y-6">
      ...
      <div className="border border-gray-800 rounded-2xl p-3 sm:p-6">
        <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-2 sm:mb-4">
          Encoder — Track Distance
        </h3>
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-4 sm:gap-x-6 gap-y-2 sm:gap-y-3">
              ...
              <div key={key} className="flex flex-col min-w-0">
                ...
                <span
                  className={[
                    ...
                    highlight ? "text-base sm:text-lg text-blue-400" : "text-sm sm:text-sm text-gray-200",
                    dirColor,
                  ]
                    .filter(Boolean)
                    .join(" ")}
      ...
      {(() => {
        ...
        return (
          <div className={`border ${statusConfig.border} ${statusConfig.bg} rounded-2xl p-3 sm:p-6`}>
            {/* Header with status badge */}
            <div className="flex items-center justify-between mb-3 sm:mb-4">
              <h3 className="text-xs font-bold uppercase tracking-widest text-gray-500">
                Plate Drops
              </h3>
              <div className={`flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1 rounded-full ${statusConfig.badge}/20`}>
            ...
            {/* Reference values */}
            <div className="flex items-center justify-center gap-4 mb-2 sm:mb-3 text-[10px] sm:text-xs text-gray-600">
            ...
            {/* Spacing details — always inline (only 4 values, not worth hiding) */}
            {dropCount > 0 && (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-2 pt-2 border-t border-gray-800/30">
                {([
              ...
              <div key={key} className="flex flex-col min-w-0">
                ...
                <span
                  className={[
                    ...
                    isNonZero ? "text-gray-300" : "text-gray-700",
                  ].join(" ")}
                >
                  {String(val)}
                </span>
