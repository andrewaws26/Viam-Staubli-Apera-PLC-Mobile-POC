...
export const PLC_REGISTER_FIELDS: {
  ...
  { key: "ds1", label: "DS1 Adj Tie Spacing" },
  { key: "ds2", label: "DS2 Tie Spacing (in)" },
  { key: "ds3", label: "DS3 Miles Laying/10" },
  { key: "ds4", label: "DS4 Detector Offset Bits" },
  { key: "ds5", label: "DS5 Detector Offset (in)" },
  { key: "ds6", label: "DS6 Plate Count" },
  { key: "ds7", label: "DS7 Avg Plates/Min" },
  { key: "ds8", label: "DS8 Detector Next Tie" },
  { key: "ds9", label: "DS9 Encoder Next Tie" },
  { key: "ds10", label: "DS10 1st Tie Distance" },
  { key: "ds11", label: "DS11 Detector Bits" },
  { key: "ds12", label: "DS12 Last Det Laid (in)" },
  { key: "ds13", label: "DS13 2nd Pass Dbl Lay" },
  { key: "ds14", label: "DS14 Tie Team Skips" },
  { key: "ds15", label: "DS15 Tie Team Lays" },
  { key: "ds16", label: "DS16 Skip+Lay-1" },
  { key: "ds17", label: "DS17 HMI" },
  { key: "ds18", label: "DS18" },
  { key: "ds19", label: "DS19 HSC Count" },
  { key: "ds20", label: "DS20" },
  { key: "ds21", label: "DS21" },
  { key: "ds22", label: "DS22" },
  { key: "ds23", label: "DS23" },
