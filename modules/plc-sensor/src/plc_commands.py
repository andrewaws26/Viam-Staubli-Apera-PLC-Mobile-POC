...
async def dispatch_command(
    ...
    *,
    plate_drop_reset_cb: Callable[[], None] | None = None,
) -> dict[str, Any]:
...
async def _handle_reset_counters(client: Any, result: dict[str, Any], plate_drop_reset_cb: Callable[[], None] | None) -> None:
    try:
